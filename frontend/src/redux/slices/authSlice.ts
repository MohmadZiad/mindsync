...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    // me
    builder.addCase(meThunk.pending, (s) => {
      s.loading = true;
      s.error = null;
    });
    builder.addCase(meThunk.fulfilled, (s, a) => {
      s.loading = false;
      s.user = a.payload;
    });
    builder.addCase(meThunk.rejected, (s) => {
      s.loading = false;
      s.user = null;
    });
